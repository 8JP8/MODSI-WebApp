...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      {/* Main content with iframe - takes full remaining height */}
      <main className="flex-1 relative overflow-hidden">
        ...
        {hasError && (
          <div className="absolute inset-0 bg-background z-10 flex flex-col items-center justify-center text-center">
